      ...
      <div className="max-w-7xl mx-auto px-10 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-10">
          {["Overview", "Features", "Strategies", "Governance", "Roadmap"].map((item) => (
            <a key={item} href={`#${item.toLowerCase()}`} className="text-[10px] font-black uppercase tracking-[0.25em] text-white/40 hover:text-white transition-colors">
              {item}
            </a>
          ))}
        </div>
...
const TypewriterLog = () => {
  ...
  return (
    <div className="font-mono text-[10px] md:text-xs text-white/80 h-12 flex items-center bg-[#050505] p-4 rounded border border-white/5">
    ...
    <div className="bg-black text-white min-h-screen selection:bg-primary/30 font-sans grid-texture">
      ...
      <SectionWrapper className="bg-black min-h-screen flex flex-col justify-center">
        <div className="space-y-4 mb-32">
          ...
          <h2 className="text-5xl md:text-7xl lg:text-9xl font-display font-black uppercase tracking-tighter leading-none">
        ...
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="max-w-3xl mx-auto space-y-10">
            <div className="flex justify-between items-end">
              ...
              <p className="text-2xl font-mono font-bold italic text-white tracking-tighter tabular-nums">${deposit.toLocaleString()}</p>
            </div>
            <div className="relative flex items-center">
              ...
              />
              <div className="absolute left-0 -bottom-8 flex justify-between w-full text-[9px] font-bold text-white/20 uppercase tracking-tighter">
                <span>$100</span>
                <span>$100,000</span>
              </div>
            </div>
      ...
      <SectionWrapper className="max-w-7xl mx-auto space-y-40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="terminal-card bg-surface p-8 relative group overflow-hidden border-primary/10">
              <div className="flex justify-between items-center mb-12">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-black uppercase text-white/40 tracking-widest">Active Connection</span>
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-black border border-white/10 p-6 rounded-sm">
                  <p className="text-[9px] font-black text-white/20 uppercase mb-2 italic">Deposit mUSDC</p>
                  <p className="text-4xl font-mono font-bold tabular-nums">10,000.00</p>
                </div>
                <button className="w-full bg-primary py-5 rounded-sm font-black uppercase italic text-xs tracking-widest shadow-[0_0_30px_rgba(173,70,255,0.2)]">
                  Execute Deposit_
                </button>
              </div>
            </div>
          ...
          <div className="space-y-6 order-1 lg:order-2">
            <p className="font-mono text-primary text-[10px] font-bold uppercase tracking-[0.4em]">Step 01</p>
            <h2 className="text-5xl md:text-7xl font-display font-black leading-none">Deposit once.</h2>
            <p className="text-secondary-text text-base md:text-lg uppercase tracking-widest leading-relaxed max-w-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-6">
            <p className="font-mono text-primary text-[10px] font-bold uppercase tracking-[0.4em]">Step 02</p>
            <h2 className="text-5xl md:text-7xl font-display font-black leading-none text-primary">Compounds <br /> daily.</h2>
            <p className="text-secondary-text text-base md:text-lg uppercase tracking-widest leading-relaxed max-w-md">
          ...
          <motion.div variants={fadeInUp}>
            <div className="terminal-card bg-surface p-10 border-primary/10 space-y-8">
              <div className="flex items-center gap-3 text-white/40 mb-4">
                <Terminal size={18} />
                <span className="text-[10px] font-black uppercase tracking-widest italic">Protocol Harvest Log</span>
              </div>
              <TypewriterLog />
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-black/40 p-4 border border-white/5 rounded-sm">
                  <p className="text-[8px] font-black text-white/20 uppercase mb-1">Last Recompound</p>
                  <p className="text-sm font-mono text-white/80 font-bold uppercase italic">Today, 00:05</p>
                </div>
                <div className="bg-black/40 p-4 border border-white/5 rounded-sm">
                  <p className="text-[8px] font-black text-white/20 uppercase mb-1">Efficiency</p>
                  <p className="text-sm font-mono text-primary font-bold uppercase italic tabular-nums">99.8%</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <motion.div variants={fadeInUp} className="order-2 lg:order-1">
            <div className="terminal-card bg-primary text-white p-12 border-none shadow-[0_0_50px_rgba(173,70,255,0.2)]">
              <div className="space-y-12">
                <div className="space-y-2">
                  <p className="text-[10px] font-black uppercase text-white/40 tracking-[0.3em] italic">Current Position</p>
                  <h4 className="text-6xl font-mono font-black italic tracking-tighter tabular-nums text-glow">$1,284.73</h4>
                ...
                <button className="w-full bg-black text-white py-5 rounded-sm font-black uppercase italic text-xs tracking-widest hover:bg-white/10 transition-all">
                  Withdraw Principal + Yield_
                </button>
              </div>
            </div>
          </motion.div>
          <div className="space-y-6 order-1 lg:order-2">
            <p className="font-mono text-primary text-[10px] font-bold uppercase tracking-[0.4em]">Step 03</p>
            <h2 className="text-5xl md:text-7xl font-display font-black leading-none">Withdraw whenever.</h2>
            <p className="text-secondary-text text-base md:text-lg uppercase tracking-widest leading-relaxed max-w-md">
      ...
      {/* Strategies */}
      <SectionWrapper id="strategies" className="bg-[#050505]">
        <div className="max-w-7xl mx-auto space-y-16 text-center">
          <div className="space-y-4">
            <p className="font-mono text-secondary-text text-[10px] font-bold uppercase tracking-[0.4em]">Yield Sources</p>
            <h2 className="text-5xl md:text-8xl font-display font-black leading-none">Two strategies. <br /> One vault.</h2>
          </div>
            ...
            {[
              ...
              >
                <div className="flex justify-between items-start mb-10">
                  <div className="space-y-1">
                    <h3 className="text-3xl font-black italic">{s.name}</h3>
                  ...
                  <div className="flex items-center gap-2 px-3 py-1 bg-[#0B7B5E]/10 border border-[#0B7B5E]/20 rounded-full">
                    ...
                    <span className="text-[8px] font-black text-[#0B7B5E] uppercase tracking-widest">Active</span>
                  </div>
                </div>
                <div className="space-y-6">
                  {s.stats.map((st, j) => (
                    <div key={j} className="flex justify-between items-end border-b border-white/5 pb-2">
                      <p className="text-[10px] font-black text-white/20 uppercase italic">{st.l}</p>
                      <p className={`text-xl font-mono font-bold italic tracking-tighter ${st.p ? "text-primary text-glow" : "text-white/80"}`}>{st.v}</p>
                    </div>
                  ))}
                </div>
                <div className="mt-8 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">{s.risk} Risk</span>
                  </div>
          ...
          <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] italic pt-8">
      ...
      <SectionWrapper id="governance">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          <div className="space-y-10 text-center lg:text-left">
            <h2 className="text-7xl md:text-9xl font-display font-black leading-[0.85] tracking-tighter">No hidden <br /> fees.</h2>
            <p className="text-secondary-text text-lg md:text-xl uppercase tracking-widest leading-relaxed max-w-md mx-auto lg:mx-0">
          ...
          <div className="flex flex-col items-center gap-12">
            ...
            >
              <div className="absolute inset-10 bg-black rounded-full flex flex-col items-center justify-center text-center p-6 border border-white/5">
                <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-1 italic">Genesis Distribution</p>
                <p className="text-4xl font-display font-black italic text-white tracking-tighter leading-none">100M</p>
                <p className="text-[10px] font-bold text-primary uppercase mt-1 tracking-widest">WEAVE</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-x-12 gap-y-6 text-[10px] font-black uppercase tracking-widest">
            ...
            <div className="w-full max-w-sm pt-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="flex-grow bg-white/5 border border-white/10 rounded-sm p-4 text-xs outline-none focus:border-primary/40 transition-all uppercase placeholder:text-white/10"
                />
                <button className="bg-primary text-white px-8 py-4 rounded-sm font-black uppercase italic text-[11px] tracking-widest">Join</button>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Roadmap */}
      <SectionWrapper id="roadmap" className="bg-[#050505]">
        <div className="max-w-7xl mx-auto space-y-16">
          <h2 className="text-5xl font-display font-black text-center italic tracking-tighter uppercase">What we're building.</h2>
          <div className="flex overflow-x-auto no-scrollbar pb-10 gap-8 lg:justify-between min-w-full">
            {[
              ...
              <div key={i} className={`flex-shrink-0 w-72 space-y-6 ${p.active ? "opacity-100" : "opacity-30"}`}>
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-[10px] font-black text-primary uppercase tracking-widest">{p.v} // {p.t}</p>
                    <h4 className="text-xl font-black italic mt-1">{p.title}</h4>
                  </div>
                  <p className="text-[10px] font-medium text-white/60 uppercase leading-relaxed tracking-widest">{p.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <SectionWrapper className="text-center space-y-12">
        <h2 className="text-7xl md:text-9xl font-display font-black uppercase italic tracking-tighter leading-none text-glow">Start earning. <br /> Right now.</h2>
        <p className="max-w-md mx-auto text-secondary-text text-sm uppercase tracking-widest leading-relaxed italic">Weave is live on Initia testnet. Get test tokens and try it in 60 seconds.</p>
        <div className="flex flex-col sm:flex-row justify-center gap-8 pt-10">
          ...
          <button className="border border-white/20 text-white/60 px-16 py-8 rounded-sm font-black uppercase italic text-xl tracking-[0.2em] hover:text-white hover:border-white transition-all">
            Get tokens
          </button>
        </div>
        <div className="flex flex-wrap justify-center gap-12 pt-24 opacity-30 text-[10px] font-black uppercase tracking-widest">
      ...
      <footer className="border-t border-white/5 bg-black p-20">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-16">
          <div className="space-y-6">
            <div className="flex items-center gap-1 group cursor-pointer">
              <span className="text-xl font-display font-bold tracking-tighter uppercase italic">Weave</span>
              <div className="w-1.5 h-1.5 rounded-full bg-primary mt-1 shadow-[0_0_10px_#ad46ff]" />
            </div>
            <p className="text-[9px] font-medium text-white/20 uppercase leading-relaxed tracking-widest max-w-[200px]">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 text-[9px] font-bold text-white/20 uppercase tracking-widest italic">
          ...
          <div className="space-y-6">
            <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Governance</p>
            <div className="flex flex-col gap-4 text-[9px] font-bold text-white/20 uppercase tracking-widest italic">
          ...
          <div className="space-y-6 text-right">
            <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">&copy; 2026</p>
            <p className="text-[9px] font-bold text-white/10 uppercase tracking-[0.3em] italic">Initia Network</p>
          </div>
        </div>
      </footer>
    </div>
